...
\tableofcontents
\newpage
\include{chapters/01_List_of_Abbreviation}
\listoffigures
\newpage
...
\input{chapters/09_Subject_matter_and_Motivation}

\section{Zielsetzung}
\input{chapters/10_Objective}

\section{Methodik und Ergebnisse}
\input{chapters/11_Methodology_and_Results}
\begin{landscape}
\section{Zeitplan}
