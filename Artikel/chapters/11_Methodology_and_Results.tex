...
\begin{description}[style=nextline, font=\bfseries\sffamily]
    \item[Methodik] 
        Die initiale Literaturrecherche lieferte insgesamt 125 Treffer, wovon 98 aus IEEE Xplore und 27 aus PubMed stammten. Dabei wurde der folgende Suchstring verwendet:
            \begin{quote}
            ...
            \end{quote}
        Nach einem Titel-, Abstract- und Volltext-Screening wurden letztendlich 27 Quellen einbezogen.
    \item[Ergebnisse]
...
\begin{description}[style=nextline, font=\bfseries]
    ...
    \begin{verbatim}
    (("Hospital Information Systems"[MeSH] OR 
    "Electronic Health Records"[MeSH]) 
    AND ("sensor*" OR "sensor data" OR "wearable*") 
    AND ("storage" OR "archiving" OR "persistence" OR "NoSQL" OR "SQL" 
    OR "Time-series database" OR "openEHR" OR "FHIR" OR "repository")) 
    NOT ("Blockchain" OR "Security" OR "Cryptography" 
    OR "Privacy Preservation" OR "Cybersecurity")
    \end{verbatim}
    
    Für die Recherche in IEEE Xplore wurde folgender Search String angewendet:
    \begin{verbatim}
    (("Hospital Information System*" OR "Electronic Record*") 
    AND ("sensor*" OR "sensor data" OR "wearable*") 
    AND ("storage" OR "archiving" OR "persistence" OR "NoSQL" OR "SQL" 
    OR "Time-series database" OR "openEHR" OR "FHIR" OR "repository")) 
    NOT ("Blockchain" OR "Security" OR "Cryptography" OR 
    "Privacy Preservation" OR "Cybersecurity")
    \end{verbatim}
    ...
    Die insgesamt $n = 14$ identifizierten Quellen wurden quantitativ analysiert und manuell hinsichtlich der verwendeten Schnittstellenstandards kategorisiert.
