...
\begin{enumerate}[label=1.\arabic*]
    ...
    \item Welche Technologien werden verwendet um Sensor-Daten ins KIS einzubinden?
    \item Welche Anforderungen werden an synthetische strukturierte Klinische Daten gestellt?
\end{enumerate}
...
\begin{enumerate}[label=2.\arabic*]
    \item Welche Anforderungen haben Spezialisten an die Daten?
\end{enumerate}
